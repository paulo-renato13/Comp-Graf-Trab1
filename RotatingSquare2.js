...
function mainEntrance() {
  ...
  var runanimation = (() => {
    ...
    return () => {
      ...
      // Get the position of all corners
      var r_corner = new Vector4([...getVertex(0), 0.0, 1.0]);
      var g_corner = new Vector4([...getVertex(1), 0.0, 1.0]);
      var b_corner = new Vector4([...getVertex(2), 0.0, 1.0]);
      var w_corner = new Vector4([...getVertex(5), 0.0, 1.0]);
      r_corner = modelMatrix.multiplyVector4(r_corner);
      g_corner = modelMatrix.multiplyVector4(g_corner);
      b_corner = modelMatrix.multiplyVector4(b_corner);
      w_corner = modelMatrix.multiplyVector4(w_corner);

      //Reverse rotation if a corner reaches a border
      if (r_corner.elements[0] >= 2.5 || r_corner.elements[0] <= -2.5 || r_corner.elements[1] >= 2.5 || r_corner.elements[1] <= -2.5 ) {
        increment=-increment;
      } else if (g_corner.elements[0] >= 2.5 || g_corner.elements[0] <= -2.5 || g_corner.elements[1] >= 2.5 || g_corner.elements[1] <= -2.5 ) {
        increment=-increment;
      } else if (b_corner.elements[0] >= 2.5 || b_corner.elements[0] <= -2.5 || b_corner.elements[1] >= 2.5 || b_corner.elements[1] <= -2.5 ) {
        increment=-increment;
      } else if (w_corner.elements[0] >= 2.5 || w_corner.elements[0] <= -2.5 || w_corner.elements[1] >= 2.5 || w_corner.elements[1] <= -2.5 ) {
        increment=-increment;
      }
